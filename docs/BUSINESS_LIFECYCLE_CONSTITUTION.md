...
| **G12 Governed execution** | Project 360 / Execution Partner | Partner works, reports progress/exceptions and submits delivery | Progress Updates, Execution Exceptions, Delivery Control Items, current-cycle Partner Delivery Submission | Deliverables may link controlled documents; open exceptions and unresolved required delivery items block progression | Submit for Internal Review |
