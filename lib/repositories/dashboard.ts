...
export async function getDashboardSnapshot(supabase: SupabaseClient, organisationId: string): Promise<DashboardSnapshot> {
  ...
  const [prospectResult, leadResult, intakeResult, partnerQuoteResult, reviewResult, quoteResult, projectResult, taskResult, activityResult] = await Promise.all([
    ...
    supabase.from('commercial_reviews').select('id, lead_id, status, client_price, margin_percent, created_at, updated_at').eq('organisation_id', organisationId).order('cÍ¼÷›h‘éì¶»§q«^u12-ak9Qy5Q7jYb2Wwcey5Fpvg2KoAc/ZIhLSLOSBmRmygPsGwkVVt0fZa0qrtMz+m6tJTAHfZQ8FnmB4MG4LWy7/w==",
      "dev": true,
      "license": "MIT",
      "engines": {
        "node": ">=8"
    ...
    "node_modules/picospinner": {
      "version": "3.1.2",
      "resolved": "https://registry.npmjs.org/picospinner/-/picospinner-3.1.2.tgz",
    ...
    "node_modules/react-email": {
      "version": "6.9.3",
      "resolved": "https://registry.npmjs.org/react-email/-/react-email-6.9.3.tgz",
      "integrity": "sha512-z2YOtq5EDNeMMz8uuZtVxmtB43nIkoPWEr8Heajkljm2clKlfE8oODtI6Me2NunmqXWaYfpv4aEFOr4ZiLmk+g==",
      "license": "MIT",
      "dependencies": {
        "@babel/parser": "7.29.2",
    ...
    "node_modules/react-email/node_modules/@babel/traverse": {
      "version": "7.29.0",
