...
const quick=[
  {title:'Dashboard',subtitle:'Owner command centre',href:'/workspace'},
  {title:'Commercial Control',subtitle:'Invoices, receipts, payables and mobilisation authority',href:'/workspace/commercial-control'},
  {title:'Executive Intelligence',subtitle:'CEO, COO and CFO operating signals',href:'/workspace/intelligence'},
  {title:'Risk & Compliance',subtitle:'Risk register, evidence and expiry control',href:'/workspace/risk'},
  {title:'Knowledge',subtitle:'Lessons, standards and reusable operating memory',href:'/workspace/knowledge'},
  {title:'Notifications',subtitle:'Delivery queue, reminders and failures',href:'/workspace/notifications'},
];
