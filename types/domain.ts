...
export interface Company { id: string; organisation_id: string; name: string; website: string | null; industry: string | null; country: string | null; employee_count: number | null; annual_revenue: number | null; notes: string | null; lifecycle_status?: 'active'|'dormant'|'archived'; account_status?: 'new'|'active'|'repeat'|'retained'|'dormant'; account_owner_id?: string|null; next_account_review_at?: string|null; future_workload?: string|null; preferred_services?: string|null; relationship_notes?: string|null; created_by: string | null; created_at: string; updated_at: string; }
export interface Contact { id: string; organisation_id: string; company_id: string | null; full_name: string; job_title: string | null; email: string | null; phone: string | null; linkedin_url: string | null; notes: string | null; lifecycle_status?: 'active'|'inactive'|'archived'; is_primary?: boolean; communication_status?: 'business_contact'|'do_not_contact'; created_by: string | null; created_at: string; updated_at: string; company?: Pick<Company, 'id' | 'name'> | null; }
