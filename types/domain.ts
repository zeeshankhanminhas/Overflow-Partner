...
export interface Company { id: string; organisation_id: string; name: string; website: string | null; industry: string | null; country: string | null; employee_count: number | null; annual_revenue: number | null; notes: string | null; account_status?: 'new'|'active'|'repeat'|'retained'|'dormant'; account_owner_id?: string|null; next_account_review_at?: string|null; future_workload?: string|null; preferred_services?: string|null; relationship_notes?: string|null; created_by: string | null; created_at: string; updated_at: string; }
