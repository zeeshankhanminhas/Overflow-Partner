...
export default async function ProspectRegisterPage(){
  ...
  const converted=prospects.filter(item=>item.status==='converted').length;
  const inProgress=prospects.filter(item=>!['qualified','converted'].includes(item.status)).length;
